...
<body>
    ...
    <header class="header">
        <div class="header-content">
            ...
            <div class="header-info">
                ...
                <a href="export-interface.php" class="config-button" title="Exportar Relatórios" style="text-decoration: none; margin-right: 10px;">
    ...
    <div class="container">
        ...
        <!-- Slide 5: Gestão de Insumos -->
        <div class="slide" id="slide-consumables">
            <h2 class="slide-title">Gestão de Insumos e Consumíveis</h2>
            ...
            <div class="stats-grid" style="grid-template-columns: repeat(4, 1fr); margin-bottom: 25px;">
                <div class="stat-card">
                    ...
                    <div class="stat-content">
                        ...
                        <div class="stat-number" id="total-consumable-items">0</div>
                    </div>
                </div>
                ...
                <div class="stat-card">
                    ...
                    <div class="stat-content">
                        ...
                        <div class="stat-number" id="total-consumable-units">0</div>
                    </div>
                </div>
            ...
            <!-- Grid de Conteúdo -->
            <div class="charts-grid" style="grid-template-columns: 2fr 1.5fr; gap: 20px;">
                <!-- Alertas de Estoque Baixo -->
                <div class="chart-container" style="max-height: 450px; overflow-y: auto;">
                    <h3><i class="fas fa-bell"></i> Alertas de Estoque Baixo</h3>
                    <table class="data-table" id="low-stock-table">
                        ...
                        <tbody>
                            <tr>
                                <td colspan="4" class="loading-cell">Carregando dados...</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
                ...
                <div class="chart-container">
                    <h3><i class="fas fa-chart-bar"></i> Top 10 Mais Consumidos (30 dias)</h3>
                    <canvas id="mostConsumedCanvas" style="max-height: 350px;"></canvas>
                </div>
            </div>
        </div>
    </div>
